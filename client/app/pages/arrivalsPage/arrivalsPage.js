...
ArrivalsPage = function(){
	...
	this.imageBackground = new ImageSurface({
		content: "/pictures/flights-arrial-v2.jpg",
		properties:{
			// userScalable:'yes'
		}
	});
...
ArrivalsPage.prototype = Object.create(View.prototype);
ArrivalsPage.prototype.constructor = ArrivalsPage;

ArrivalsPage.DEFAULT_OPTIONS = {};